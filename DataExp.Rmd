...
tot_turf_prod[1:10,1:10]
t(pred_val)[1:10,1:10]
unit
ts_data
...
cbind(ts_data,
      turf_prod_mean=apply(pred_val,2,median),
      turf_prod_lhdi=apply(pred_val,2,function(x) median_hdci(x)$ymin),
      turf_prod_uhdi=apply(pred_val,2,function(x) median_hdci(x)$ymax))
